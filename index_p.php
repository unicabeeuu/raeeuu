        ...
        <div class="slider-active-wrap owl-carousel text-center text-md-left">
            ...
            <?php 
                ...
                while ($rowBanner = mysqli_fetch_array($exe_banner1)) {
                    if($rowBanner['id'] == 26 || $rowBanner['id'] == 27 || $rowBanner['id'] == 28 || $rowBanner['id'] == 29 || $rowBanner['id'] == 30) {
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-title">
                        <h2>Blog <img src="assets/img/logo_conectados1_1.jpg" class="img-fluid"/></h2>
                    </div>
                </div>
            </div>
            <!--== Section Title End ==-->
