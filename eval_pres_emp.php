            ...
            $.ajax({
        		...
        		success:function(r) {
        		    ...
        		    if(r_est == "EMP") {
        		        ...
        		        $("#msgdocumento").html("Este documento no está habilitado para presentar la evaluación.");
                                            ...
                                            <div class="register-form-wrap">
                                                ...
                                                <div class="register-form" id="divform">
                                                    ...
                                                    <div class="row ghf">
                                                        ...
                                                        <p><i class="fa fa-chevron-right"></i> Al concluir la evaluación, encontraras un <strong>resumen del resultado y una hoja de ruta sugerida, </strong>para
                                                        ...
                                                        <p><i class="fa fa-chevron-right"></i> <strong>Cada pregunta tiene un solo intento.</strong> Pero se puede pausar la evaluación y volver a ingresar luego para completarla.
                                                        </p>
                                                        
                                                    </div>
                                                        
                                                    <form name="formulario" id="formulario" method="post" action="eval_pres_emp1.php" enctype="multipart/form-data">
