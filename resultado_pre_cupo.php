            ...
            <div class="row">
                <div class="col-lg-8 m-auto text-center">
                    <div class="page-title-content">
                        <?php
                            if($resultados[0] == "CorreoOK") {
                                echo "<h4>¡EL CORREO DE CUPO APARTADO SE ENVIÓ CON ÉXITO a ".$resultados[1]."!</h4>";
                                echo "<h5>Las matrículas las estaremos anunciando para el mes de diciembre.</h5>";
                                echo "<h5>Al abrir el correo es probable que le aparezca una imagen como la siguiente:</h5>";
								...
								echo "<a href='registro/adminunicab/php/loginEstudiante1.php?u=".$resultados[4]."&d=".$resultados[3]."&p=cupo' class='btn btn-brand smooth-scroll'>Ver en Registro</a>";
                            }
                            else if($resultados[2] == "OK") {
                                //echo "<h4 class='h4'>¡SE PRESENTARON ERRORES EN EL PROCESO DE ENVIO DE CORREO!</h4><hr>";
                                echo "<h4 class='h4'>¡LA SOLICITUD DE APARTAR CUPO FUE EXITOSA!</h4><hr>";
                                //echo "<h4>Resumen:</h4><h5>Error enviado correo al email registrado.</h5>";
                                echo "<hr>";
								echo "<a href='registro/adminunicab/php/loginEstudiante1.php?u=".$resultados[4]."&d=".$resultados[3]."&p=cupo' class='btn btn-brand smooth-scroll'>Ver en Registro</a>";
								//echo "<hr>";
								//echo "<p>Si el error persiste, comunicate con Secretaría Académica e informa los datos ingresados para revisar.</p>";
								
                            }
                            else if($mensjae == "_") {
                                echo "<h4 class='h4'>¡SE PRESENTARON ERRORES EN EL PROCESO DE ENVIO DE CORREO!</h4><hr>";
                                echo "<h4 class='h4'>¡SIN EMBARGO LA SOLICITUD DE APARTAR CUPO FUE EXITOSA!</h4><hr>";
                                echo "<hr>";
								//echo "<a href='pre_cupo.php' class='btn btn-brand smooth-scroll'>Intentar nuevamente</a>";
								echo "<a href='registro/adminunicab/php/loginEstudiante1.php?u=".$resultados[4]."&d=".$resultados[3]."&p=cupo' class='btn btn-brand smooth-scroll'>Ver en Registro</a>";
								//echo "<hr>";
								//echo "<p>Si el error persiste, comunicate con Secretaría Académica e informa los datos ingresados para revisar.</p>";
