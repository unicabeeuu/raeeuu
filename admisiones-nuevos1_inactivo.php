            ...
            $.ajax({
        		...
        		success:function(r) {
        		    ...
        		    if(r_est == "activo") {
        		        ...
        		        $("#msgdocumento").html("Documento nuevo, puede realizar proceso de matrícula.");
                                                ...
                                                <div class="register-form" id="divform">
                                                    <form name="formulario" id="formulario" method="post" action="php/formulario_admisiones/send_f.php" enctype="multipart/form-data"> 
                                                        ...
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto"><i class="fa fa-upload"></i> Adjunta el contrato 
                                                        ...
                                                        <!--CARGA DE ARCHIVO-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto6"><i class="fa fa-upload"></i> Adjunta el certificado de Retiro del SIMAT
                                                        ...
                                                        <!--CARGA DE RUT-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto9"><i class="fa fa-upload"></i> Adjunta el RUT
                                                            ...
                                                            <input type="file" id="adjunto11" name="adjunto11" accept=".pdf,.jpg,.png,.jpeg,docx.doc" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE RUT-->
