                ...
                <div class="col-lg-8 m-auto text-center">
                    <div class="page-title-content">
                         <?php 
										 	if($mensaje=="si")
											{
												echo "<h1 class='h2'>¡EL FORMULARIO SE ENVIÓ CON ÉXITO!</h1><hr>";
												echo "<h5>Por favor escríbenos por whatsapp al número 315 696 52 91 para confirmar que los documentos fueron recibidos.</h5><hr>";
											...
											{
												echo "<h1 class='h2'>¡SE PRESENTÓ UN ERROR EN EL PROCESO!</h1>";
												
												echo "<p>ENVÍANOS UN CORREO A matriculas.academica@unicab.org</p>";
												echo "<a href='admisiones.php' class='btn btn-brand smooth-scroll'>Intentar nuevamente</a>";
											}
