                                                            ...
                                                            <div class="col-12 col-sm-12">
                                                                <div class="jumbotron jumbotron-fluid">
                                                                    <div class="container" align="center" id="contieneSelect">
                                                                        <h3 class="display-4xxx">Iniciar sesión</h3>
                                                                        <div class="form-group" align="center" id="contieneSelect2">
                                                                            <form action="admin-unicab/php/login_estados1.php" method="POST" onsubmit="javascript:return Validar(this);" >
                                                                                <input type="email" class="form-control" id="email" name="email" placeholder="Usuario &#9658; email" autofocus="" oninput="validar_email()" required>
                                                        						<br><input type="password" class="form-control" id="pass" name="pass"  placeholder="Password" required>
