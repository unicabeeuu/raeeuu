...
<head>
    ...
    <script>
        ...
        function mostrar_grados(documento) {
            ...
            $.ajax({
        		type:"POST",
        		url:"cargar_grados_validacion.php",
        ...
        function val_documento() {
            ...
            $.ajax({
        		...
        		success:function(r) {
        		    ...
        		    var r_fecha_val = res.fecha_validacion;
        		    ...
        		    if(res.eval_val_estado == "PRESENTADA") {
        		        $("#msgdocumento").html("Este documento ya presentó evaluación de validación para el grado " + res.grado + ".");
                        ...
                        if(r_fecha_val == "OK") {
                            ...
                            if(r_fecha_val == "NO") {
                                $("#msgdocumento").html("Este documento aún no se ha programado para validar.");
                                //$("#msgdocumento").show();
                                ...
                                //alert(r_fecha_val);
                                $("#msgdocumento").html("La fecha de programación de ésta validación es posterior a la fecha actual.");
                                //$("#msgdocumento").show();
                        ...
                        $("#msgdocumento").html("Este documento no esta habilitado para presentar examen de validación.");
            ...
            <div class="row">
                <div class="col-lg-8 m-auto text-center">
                    <div class="page-title-content">
                        <h1 class="h2">Evaluación validación</h1>
                                            ...
                                            <div class="register-form-wrap">
                                                ...
                                                <div class="register-form" id="divform">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-sm-12">
                                                            <div class="jumbotron jumbotron-fluid">
                                                                <div class="container" align="center" id="contieneSelect">
                                                                    <h3 class="display-4">Número de documento de identidad del estudiante (sin puntos)</h3>
                                                                    <div class="form-group" align="center" id="contieneSelect2">
                                                                        ...
                                                                        <button id="btncontinuar" class="btn btn-brand smooth-scroll" onclick="val_documento();">Continuar</button>
                                                                        
                                                                        <input type="hidden" id="register_estado"/><br>
                                                                    </div>
                                                                    <div id="divgrados" style="display: none;">
                                                                        <h3 class="display-4">Grado a validar</h3>
                                                                        <div id="divselgra">
                                                                            <!--</div><br>
                                                        ...
                                                        <div class="row ghf">
                                                            <h4>Bienvenido a esta evaluación de validación <label id="lblgrado"></label>.</h4>
                                                            ...
                                                            <p><i class="fa fa-chevron-right"></i> <strong>Cada pregunta tiene un sólo intento.</strong> Pero se puede pausar la evaluación y volver a ingresar luego para completarla. 
                                                            <!--<strong>Pero recuerda que es requisito para completar la matrícula.</strong>-->
                                                            </p>
                                                            <p><i class="fa fa-chevron-right"></i> La evaluación consta de <strong><label id="lblct_preg"></label> preguntas</strong> (o menos).
                                                            </p>
                                                            
                                                        </div>
                                                        
                                                        <form name="formulario" id="formulario" method="post" action="eval_val1.php" enctype="multipart/form-data">
