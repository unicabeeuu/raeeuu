                    ...
                    <div class="page-title-content">
                        <?php
                            if($resultados[0] == "CorreoOK" && $resultados[1] == "EstudianteOK") {
                                echo "<h4>¡EL REGISTRO SE TERMINÓ CON ÉXITO!</h4><hr>";
                                echo "<h4>¡EL CORREO SE ENVIÓ CON ÉXITO a ".$resultados[2]."!</h4>";
                                ...
                                echo "<h4>Resumen:</h4><h5>Error enviando correo al emial del ".$resultados[2]." acudiente.</h5>";
                                echo "<hr>";
