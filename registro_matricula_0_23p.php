<?php
	...
	//Se valida que el código corresponda con el documento
	$ct_23P = 0;
	$control_c23P = 0;
	$datos->codigo23P = "NO";
	$sql_c23P = "SELECT COUNT(1) ct FROM tbl_cod_pre_matricula_23periodos WHERE identificacion = '$documento' AND codigo = '$codigo23P'";
	$resultado_c23P = $mysqli1->query($sql_c23P);
	while($row_c23P = $resultado_c23P->fetch_assoc()) {
	    $ct_23P = $row_c23P['ct'];
	}
	if ($ct_23P > 0) {
		$datos->codigo23P = "SI";
