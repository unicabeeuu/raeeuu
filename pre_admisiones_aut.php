    ...
    <script>
        ...
        function mostrar_submit() {
            ...
            control = parseInt($("#ctr_register_apellidos").val()) + parseInt($("#ctr_register_nombres").val()) + parseInt($("#ctr_register_documento").val()) + 
                ...
                parseInt($("#ctr_register_correoA1").val()) + parseInt($("#ctr_register_rh").val());
...
<body>
    ...
    <section id="page-title-area">
        <div class="container">
            ...
            <div class="row">
                <img src="assets/img/admisiones_2022_1.jpeg"/>
                <div class="col-lg-8 m-auto text-center">
                    <div class="page-title-content">
                        ...
                        <p>Consulta aquí los costos aprobados por la Secretaría de Educación de Sogamoso para el año 2021</p>
                        <a href="assets/descargas/costos/Costos_Colegio_2021.pdf" target="_blank" class="btn btn-brand smooth-scroll">Circular 004 de 2021 Colegio Regular</a><br><br>
