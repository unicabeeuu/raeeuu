	...
	<script>
        ...
        function val_documento() {
			...
			if (controlClave == 0) {
				...
				$("#msgdocumento").html("Clave incorrecta");
			}
			...
			$.ajax({
				...
				success:function(r) {
					...
					if(res.procesoAbierto == "SI") {
						$("#msgdocumento").html("Este documento ya tiene un proceso de matrícula abierto");							
					}
					else if(res.conCodigo23P == "SI") {
						let texto = "Este documento ya tiene un link generado para matrícula de segundo o tercer periodo: " + res.enlace;
						$("#msgdocumento").html(texto);							
					}
					else {
						let texto = "Link de matrícula generado con éxito. Por favor guardar el documento y el link generado: " + res.enlace;
						$("#msgdocumento").html(texto);
					}					
					//$('#exampleModalScrollable').modal('hide');
					$("#cargando").hide();
					...
					<div class="row">
						<div class="col-12">
							<div class="form-group">
								<label for="register_clave"><label class="obligatorio">*</label> Ingrese clave de seguridad</label>
								<input type="password" class="form-control" id="register_clave" name="register_clave" >
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
							<div class="form-group">
								<label for="register_nombres"><label class="obligatorio">*</label> Escribe el número documento estudiante y luego haz clic fuera del cuadro de texto para generar link</label>
