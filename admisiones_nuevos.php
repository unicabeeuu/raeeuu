...
<body>
	...
	<div class="container" id="divCuatro">
		...
		<div class="row">
			<div class="col-12">
				<center><h5 id="subTituloCuatro"><strong>Documentos para formalizar matrícula de estudiantes nuevos</strong></h5></center>
			</div>
		</div><br><br>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4">
				<img src="assets/img/admisiones/estudiantes_nuevos.png" alt="" class="img-fluid imgCuatro"/>
				<div id="divRequisitos">
					<h6 id="tituloRequisitos"><img src="assets/img/admisiones/flecha-96.png" alt="" class="img-fluid" style="width: 2em;"/> REQUISITOS ESTUDIANTES NUEVOS</h6>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4">				
			</div>
		...
		<div class="row">
			...
			<div class="col-11">
				<p class="pRequisitos">
					Hoja de vida, observador o reporte comportamental y académico colegio anterior.
				</p>
			</div>
		</div>
	...
	<div class="container" id="divCinco">
		<div class="row">
			<div class="col-12">
				<center><h6 id="tituloCinco"><strong>PARA INGRESAR A UN GRADO DE PRIMARIA:</strong></h6></center>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-11">
				<p class="pCinco">
					Aportar certificado de las notas obtenidas en el grado anterior al que aspira en el cual conste la aprobación del mismo.
				</p>
			</div>
		</div><br>
	</div>
	
	<div class="container" id="divSeis">
		<div class="row">
			<div class="col-12">
				<center><h6 id="tituloSeis"><strong>PARA INGRESAR A BACHILLERATO:</strong></h6></center>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-11">
				<p class="pSeis">
					Aportar certificado de las notas obtenidas en el grado 5 y hasta el anterior al que aspira acceder en el cual conste la aprobación de los mismos.
				</p>
			</div>
		</div><br>
	</div><br>
