<?php
	...
	$petecion0=mysqli_query($conexion,$sql);
...
<head>
    ...
    <script>
        ...
        function mostrar_submit() {
            ...
            var d = parseInt($("#ctr_register_txtgrado").val());
            //alert(a);
            ...
            control = parseInt($("#ctr_register_apellidos").val()) + parseInt($("#ctr_register_nombres").val()) + parseInt($("#ctr_register_documento").val()) + 
                parseInt($("#ctr_register_grado").val()) + 
                parseInt($("#ctr_register_nombresA").val()) + parseInt($("#ctr_register_celularA").val()) + 
                parseInt($("#ctr_register_correoA").val()) + parseInt($("#ctr_register_correoA1").val());
            ...
            if(doc == "0" || cifra == "0") {
                ...
                $.ajax({
            		...
            		success:function(r) {
                        ...
                        //alert(res.idgra_actual);
                        if(res.registro_cupo != "0") {
                            var r_grado = res.grados[0].gra;
            		        $("#msgdocumento").html("Este documento ya tiene una solicitud de apartar cupo para el 2023.");
                        ...
                        else if(res.idgra_actual == "12" || res.idgra_actual == "18") {
                            //alert("Este documento ya se encuentra activo en el grado " + r_grado);
            		        $("#msgdocumento").html("Este documento es de último grado y no aplica para apartar cupo.");
            		    ...
            		    //else if(r_est == "nuevo" && res.cod_ent == 0) {
            		        ...
            		        $("#msgdocumento").html("Documento nuevo. Para empezar proceso de matrícula, por favor comuníquese a los números 310 753 7532 / 300 815 6531.");
            		        $("#grado_permitido").val(0);
            		    ...
            		    else if(r_est == "aprobado" || r_est == "reprobado" || r_est == "retirado" || r_est == "activo") {
            		        var r_grado = res.grados[0].gra;
            		        ...
            		        /*if(eval_val == "SI" && res_val == "APROBADO") {
            		            $("#msgdocumento").html("Estudiante antiguo, puede apartar cupo para el grado " + res.gra_a_matricular + ".");
            		            $("#grado_permitido").val(res.idgra_a_matricular);
            		            $("#register_txtgrado").val(res.gra_a_matricular);
            		        }
            		            ...
            		            $("#msgdocumento").html("Estudiante antiguo, puede apartar cupo para el grado " + r_grado + ".");
            		            $("#grado_permitido").val(grados[0].id_gra);
            		            $("#register_txtgrado").val(grados[0].gra);
            		        }*/
                            ...
                            res.acudiente != "" ? $("#ctr_register_nombresA").val(0) : $("#ctr_register_nombresA").val(1);
                            res.telA != "" ? $("#ctr_register_celularA").val(0) : $("#ctr_register_celularA").val(1);
                            res.emailA != "" ? $("#ctr_register_correoA").val(0) : $("#ctr_register_correoA").val(1);
                            res.emailA != "" ? $("#ctr_register_correoA1").val(0) : $("#ctr_register_correoA1").val(1);
                            
                            mostrar_submit();
            		    }
            		    else {
            		        $("#msgdocumento").html("No se pudo procesar la solicitud de apartar cupo para éste documento. Comunícate con Secretaría Académica.");
            ...
            <div class="row">
                ...
                <div class="col-lg-8 m-auto text-center">
                    <div class="page-title-content">
                        <h3>APARTA TU CUPO PARA EL 2023</h3>
                                        ...
                                        <div class="col-lg-12 col-md-12 ml-auto">
                                            <div class="register-form-wrap">
                                                ...
                                                <div class="register-form" id="divform">
                                                    ...
                                                    <form name="formulario" id="formulario" method="post" action="pre_cupo1.php" enctype="multipart/form-data">
                                                        ...
                                                        <div class="ghf">
                                                            ...
                                                            <p><i class="fa fa-hand-o-right"></i> <strong>A la dirección de correo del acudiente le llegará un correo confirmando que el cupo se apartó</strong></p>
                                                        ...
                                                        <div class="row ghf">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="register_grado" id="lblgrado">Grado al que ingresa según sistema</label><br>
                                                                    <input type="text" class="form-control" id="register_txtgrado" name="register_txtgrado" required disabled="disabled">
                                                                    <input type="hidden" style="width: 20px" id="ctr_register_txtgrado" value="1"/> 
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label for="register_grado_acudiente" id="lblgrado">Grado solicitado por el acudiente</label><br>
                                                                    <select class="form-control snormal" id="register_grado_acudiente" name="register_grado_acudiente" requiered>
                                                                        <option value="0" selected>Seleccione grado</option>
                                                                        <?php
                                                                            while ($row = mysqli_fetch_array($petecion0)) {
                                                                                echo '<option value="'.$row['id'].'">'.$row['grado'].'</option>';
                                                                            }
                                                                        ?>
                                                                    </select>
                                                                    <input type="hidden" style="width: 20px" id="ctr_register_grado_acudiente" value="1"/> 
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row ghf">
                                                            <div class="col-12 col-sm-12">
               											    ...
               											    <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="register_nombresA" name="register_nombresA" placeholder="Escribe el nombres del acudiente" required onkeyup="mayus(this, 'register_nombresA', 'Nombres acudiente');">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="register_pregunta">¿Por qué escoge a UNICAB como colegio?</label>
                                                                    <textarea class="form-control" id="register_pregunta" name="register_pregunta" onkeyup="mayus(this, 'register_pregunta', 'Pregunta');"></textarea>
                                                                    <input type="hidden" style="width: 20px" id="ctr_register_pregunta" value="1"/>
                                                                </div>
                                                            </div>
