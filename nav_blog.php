		...
		background-color: #5eea8e;
            ...
            <div class="container">
                <div class="row text-center" id="b_encabezado">
                    ...
                    ?>
                    <!--<div class="col-sm pt-4 pb-4" id="b_grupoinvestigacion">
                        <a href="articulos.php?opcion=grupo-investigacion-GIU"> Grupo de investigación GIU</a>
                    </div>
                    <div class="col-sm pt-4 pb-4" id="b_talentos">
                       <a  href="articulos.php?opcion=talentos-excepcionales">Talentos excepcionales</a> 
                    </div>
                    <div class="col-sm pt-4 pb-4" id="b_condecoraciones">
                     <a  href="articulos.php?opcion=condecoraciones">Condecoraciones</a>  
                    </div>
                    <div class="col-sm pt-4 pb-4" id="b_experiencias">
                       <a  href="articulos.php?opcion=experiencias-exitosas">Experiencias exitosas</a> 
                    </div>-->
                </div>
            </div>
</body>
