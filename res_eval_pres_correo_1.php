<?php
	...
	//servidor
	//header('location: resultado_eval_pres.php?n_documento='.$documento.'&idgra='.$idgra.'&msg='.$msg_correo);
    //echo "<script>location.href='resultado_eval_pres.php?n_documento=".$documento."&idgra=".$idgra."&msg=".$msg_correo."';</script>";
