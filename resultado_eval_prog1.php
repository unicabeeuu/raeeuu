<?php
    ...
    else if($obj_json_decode['phpl']['ctok'] / $totphp > 0.25) {
        $nivphp = "MEDIO";
        $colphp = "#FFC300";
    }
    else {
                                                            ...
                                                            <table id="tblglobal" style="text-align: center;">
                                                                <thead style="font-family: 'PT Sans Narrow';">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="100px" style="background: #093A5F; color: #F1F1F2; font-weight: bold; border: 2px solid black;">PHP</td>
                                                                        <td width="100px" style="background: #093A5F; color: #F1F1F2; font-weight: bold; border: 2px solid black;">MYSQL</td>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    $linea .= '<td style="border: 2px solid black; color: #093A5F; font-weight: bold;">'.$obj_json_decode['php']['ctok'].' / '.$obj_json_decode['php']['ctpen'].'</td>';
                                                                    $linea .= '<td style="border: 2px solid black; color: #093A5F; font-weight: bold;">'.$obj_json_decode['mysql1']['ctok'].' / '.$obj_json_decode['mysql1']['ctpen'].'</td>';
                                                                    ...
                                                                    $linea .= '<td style="color: '.$colphp.'; border: 2px solid black; font-weight: bold;">'.$nivphp.'</td>';
                                                                    $linea .= '<td style="color: '.$colmysql1.'; border: 2px solid black; font-weight: bold;">'.$nivmysql1.'</td>';
