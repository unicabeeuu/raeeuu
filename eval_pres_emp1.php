<?php
    ...
    $sql = "SELECT e.id, e.nombres, e.apellidos, g.id, g.grado 
    FROM estudiantes e,grados g 
    WHERE e.periodo_ing = g.id AND e.n_documento = '$documento'";
	//echo $sql;
