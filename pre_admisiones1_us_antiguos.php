<?php
	...
	try {
		...
		$filtroConsultaNumeroContrato = $idgra."G";
		$sql_contrato = "SELECT COUNT(1) ct FROM tbl_contratos WHERE n_documento = '$documento' AND año = $fanio AND n_contrato like '%".$filtroConsultaNumeroContrato."%'";
	...
	header('Location: https://unicab.solutions/pre_admisiones2_us_antiguos2025.php?documento='.$documento.'&c='.$codigo.'&msgest='.$msg_estudiante);
