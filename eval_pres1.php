<?php
    ...
    WHERE e.id = m.id_estudiante AND m.id_grado = g.id AND e.n_documento = '$documento' AND m.estado IN ('solicitud', 'activo') AND m.n_matricula like '%2023%'";
	//echo $sql;
    ...
    for($i = 0; $i < $longitud_temas; $i++) {
    	...
    	/*$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_ct_preguntas_f 
    	    WHERE id_grado = $idgrado AND id_materia = ".$array_materias_final[0]." AND incluir = 'SI'";*/
    ...
    for($i = 0; $i < $longitud_temas; $i++) {
        ...
        //Se consulta la cantidad de preguntas definidas por cada tema
    	/*$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_ct_preguntas_f 
    	    WHERE id_grado = $idgrado AND id_materia = ".$array_materias_final[1]." AND incluir = 'SI'";*/
    	$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_temas_preguntas 
    ...
    for($i = 0; $i < $longitud_temas; $i++) {
        ...
        //Se consulta la cantidad de preguntas definidas por cada tema
    	/*$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_ct_preguntas_f 
    	    WHERE id_grado = $idgrado AND id_materia = ".$array_materias_final[2]." AND incluir = 'SI'";*/
    	$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_temas_preguntas 
    ...
    for($i = 0; $i < $longitud_temas; $i++) {
        ...
        //Se consulta la cantidad de preguntas definidas por cada tema
    	/*$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_ct_preguntas_f 
    	    WHERE id_grado = $idgrado AND id_materia = ".$array_materias_final[3]." AND incluir = 'SI'";*/
    	$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_temas_preguntas 
    ...
    for($i = 0; $i < $longitud_temas; $i++) {
        ...
        //Se consulta la cantidad de preguntas definidas por cada tema
    	/*$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_ct_preguntas_f 
    	    WHERE id_grado = $idgrado AND id_materia = ".$array_materias_final[4]." AND incluir = 'SI'";*/
    	$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_temas_preguntas 
    ...
    for($i = 0; $i < $longitud_temas; $i++) {
        ...
        //Se consulta la cantidad de preguntas definidas por cada tema
    	/*$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_ct_preguntas_f 
    	    WHERE id_grado = $idgrado AND id_materia = ".$array_materias_final[5]." AND incluir = 'SI'";*/
    	$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_temas_preguntas 
	...
	if($idgrado == 11 || $idgrado == 12 || $idgrado == 17 || $idgrado == 18 ) {
        ...
        for($i = 0; $i < $longitud_temas; $i++) {
            ...
            //Se consulta la cantidad de preguntas definidas por cada tema
        	/*$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_ct_preguntas_f 
        	    WHERE id_grado = $idgrado AND id_materia = ".$array_materias_final[6]." AND incluir = 'SI'";*/
        	$sql_cantidad_preg_tema = "SELECT ct_preguntas FROM tbl_temas_preguntas 
...
<head>
    ...
    <script>
        ...
        function primer_pregunta() {
            ...
            var tot_conteo = parseInt($("#txtconteo").val());
            var tot_totpreg = parseInt($("#txttotalpreg").val());
            //alert("tot_conteo " + tot_conteo + ", tot_totpreg " + tot_totpreg);
        ...
        function sig_pregunta() {
            ...
            var conteo = parseInt($("#txtconteo").val());
            conteo++;
            //alert(conteo);
        ...
        function actualizar_respuesta(tp) {
            ...
            var respuesta2 = $("#txt_respuesta2").val(); //Esta es la respuesta 2 ok de la pregunta cargada desde la base de datos
            var respuesta3 = $("#txt_respuesta3").val(); //Esta es la respuesta 3 ok de la pregunta cargada desde la base de datos
            var resultado = "";
                                                ...
                                                <div class="register-form" id="divform">
                                                    <!--<form name="formulario" id="formulario" method="post" action="" enctype="multipart/form-data">-->
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <p class="p1"><i class="fa fa-chevron-right"></i> Todas las preguntas están relacionadas con contenidos y temas <strong>que son necesarios conocer</strong> para que puedas 
                                                                desarrollar todas las actividades de grado <strong><?php echo $grado; ?></strong>.
                                                            </p>
                                                            <p class="p1"><i class="fa fa-chevron-right"></i> Una vez más te recordamos que al concluir la evaluación, encontraras un <strong>resumen del resultado y una hoja de ruta sugerida, </strong>para
                                                                esta servirá para convertir tus falencias en fortalezas e integrarlas a los conocimientos requeridos para este grado.
                                                            </p>
