            ...
            <div class="row">
                <div class="col-lg-8 m-auto text-center">
                    <div class="page-title-content">
                         <h1 class="h2">Admisiones</h1>
                        <p>Selecciona una opción e inicia el proceso</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <article class="single-blog-content-wrap">
                        <header class="article-head" align="center">
                        
                        <div class="alert alert-success" role="alert">
  <h4 class="alert-heading">Importante!</h4>
  <p>Los formularios de matrícula y admisión son diferentes para los estudiantes nuevos y antiguos, por favor selecciona la opción según corresponda</p>
  <hr>
   <a href="admisiones-nuevos.php" class="btn btn-brand smooth-scroll">Estudiantes Nuevos</a>
   <a href="admisiones-antiguos.php" class="btn btn-brand smooth-scroll">Estudiantes Antiguos</a>
</div>
	...
	function medir(uploadField)
	{
		uploadField.onchange = function() {
			if(this.files[0].size > 2048000){
			   alert("El archivo es muy grande, el tamaño máximo es 2048 kB");
			   this.value = "";
