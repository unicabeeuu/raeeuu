...
<body>
    ...
    <div class="row">
		<div class="col-12">
			<center>
				<img src="assets/img/admisiones/img_antiguos_2025_1.png" id="imgh1" class="img-fluid" width="90%"/>
			</center>
		</div>
	</div><br>
    <!--== Header Area End ==-->
	...
	<div class="container" id="divCuatro">
		...
		<div class="row">
			...
			<div class="col-11">
				<p class="pRequisitos">
					Imagen de consignación efectuada por concepto de matrícula para el año 2025.
				</p>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-11">
				<p class="pRequisitos">
					Contrato de matrícula, Pagaré y consentimiento informado <span style="color: red;"><strong>firmados y autenticados en notaría</strong></span> (Archivo enviado al correo del 
		...
		<div class="row">
			...
			<div class="col-11">
				<p class="pRequisitos">
					...
					de ciudadanía para mayores de 18 años). <span style="color: red;"><strong>Solo si cambió</strong></span>.
				</p>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-11">
				<p class="pRequisitos">
					Documento de identidad del acudiente, (misma persona que firma el contrato). <span style="color: red;"><strong>Solo si cambió</strong></span>.
				</p>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-11">
				<p class="pRequisitos">
					Certificado de actividad extracurricular. <span style="color: red;"><strong>Solo si cambió</strong></span>.
				</p>
			</div>
		</div>				
	</div><br><br>
