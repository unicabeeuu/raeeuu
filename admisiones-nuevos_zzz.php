...
<div class="alert alert-info" role="alert" align="center">
  ...
  <p>Este formulario lo deben diligenciar solo los estudiantes nuevos</p>
  <hr>
  <p class="mb-0">Sí eres estudiante antiguo <a href="admisiones-antiguos.php" title="Ir a página de estudiantes antiguos" class="alert-link">selecciona este enlace</a></p>
</div><br><hr>
                                            
                                                <h3><span class="badge badge-success">Paso 1</span> Información del Estudiante Nuevo</h3>
                                                
                                  
                                                
                                                <div class="register-form">
        <form name="formulario" id="formulario" method="post" action="php/formulario_admisiones/send.php" enctype="multipart/form-data"> 
                                                        <div class="row">
                                      ...
                                      <select class="form-control form-control-lg snormal" id="register_tipo_documento" name="register_tipo_documento">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="register_documento">Número de documento de identidad (sin puntos)</label>
                                                                    ...
                                                                    <input type="text" class="form-control" id="register_documento" name="register_documento" required placeholder="Escribe el número de documento del estudiante sin puntos" maxlength="20" onkeyup="validar_numero('register_documento', 'Número de documento');">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="register_lugar" name="register_lugar" required placeholder="Escribe el lugar de expedición del documento del estudiante" onkeyup="mayus(this, 'register_lugar', 'Lugar de nacimiento');">
                                                             ...
                                                             <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                 <label for="register_genero">Género</label><br>
                                      <select class="form-control form-control-lg snormal" id="register_genero" name="register_genero">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                              <label for="register_codigo">Código de Entrevista <a data-toggle="collapse" href="#collapseExampleAyuda"
     role="button" aria-expanded="false" aria-controls="collapseExampleAyuda"> (Ayuda)</a> </label>
                                                        <input type="number" class="form-control" id="register_codigo" name="register_codigo" placeholder="Contacta al psícologo de UNICAB" required onkeyup="comprobarCodigo();" onBlur="comprobarCodigo()" maxlength="11">
                                                        <span id="estado_codigo"></span> 
                                                        <div class="collapse" id="collapseExampleAyuda">
      <div class="card card-body">
         <a style="color:#0C0; display:inline-block;" href="directorio.php"><i class="fa fa-download"></i> Contacta aquí al psicólogo de Unicab</a> y solicita tu código para completar el proceso.
      </div>
    </div>
                                                                </div>
                                                            </div>
...
<div class="form-group file-input">   
<label for="adjunto6">
<i class="fa fa-upload"></i> Adjunta el certificado de Retiro del SIMAT
<a data-toggle="collapse" href="#collapseExample8" role="button" aria-expanded="false" aria-controls="collapseExample8"> (Ayuda)</a></label><br>
  ...
  <p>Escanea y sube el certificado de retiro del SIMAT del colegio anterior <span class="badge badge-secondary">Formato PDF</span></p>
    ...
    <input type="file" id="adjunto6" name="adjunto6" required accept=".pdf,.jpg,.png,.jpeg,docx.doc" class="ArchivosAdjuntos">
</div>
<!--FIN CARGA DE ARCHIVO-->
<!--CARGA DE ARCHIVO-->
<div class="form-group file-input">   
