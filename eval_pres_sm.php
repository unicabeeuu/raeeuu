<?php
	...
	//eval_pres_sm (sin matrícula)
    //https://unicab.org/eval_pres_sm.php
        ...
        function val_documento1() {
            ...
            $.ajax({
        		...
        		success:function(r) {
        		    ...
        		    //Se habilita sólo para primaria
        		    /*if(r_idgrado > 6) {
        		        $("#msgdocumento").html("Por ahora esta evaluación sólo está habilitada para primaria. En breve estará habilitada para bachillerato.");
        		    ...
        		    if(control == 0) {
            		    ...
            		    if(r_est == "solicitud" || r_est == "activo") {
            		        $("#msgdocumento").html("");
                                        ...
                                        <div class="col-lg-12 col-md-12 ml-auto">
                                            <div class="register-form-wrap">
                                                ...
                                                <div class="register-form" id="divform">
                                                    ...
                                                    <div class="row ghf">
                                                        <h4>Bienvenido a la evaluación de presaberes</h4>
                                                        <p><i class="fa fa-chevron-right"></i> El propósito de esta evaluación es ayudarte a identificar las falencias en los conceptos previos o presaberes, en los
                                                            cuales debes investigar y profundizar para desarrollar las actividades de cada pensamiento.
                                                        </p>
                                                        <p><i class="fa fa-chevron-right"></i> Al concluir la evaluación encontrarás un <strong>resumen del resultado y una hoja de ruta sugerida, </strong>esta servirá para convertir tus falencias en fortalezas e integrarlas a los conocimientos requeridos para este grado.
                                                        </p>
                                                        <!--<p><i class="fa fa-chevron-right"></i> <strong>Esta evaluación es requerida para completar tu proceso de matrícula.</strong>
                                                        </p>-->
                                                        <p id="ct_preg_sf"><i class="fa fa-chevron-right"></i> La evaluación consta de <strong><label id="lblct_preg"></label> preguntas</strong> (o menos) no calificables cuantitativamente y <strong>no hay límite de tiempo.</strong>
                                                        </p>
                                                        <!--<p id="ct_preg_cf"><i class="fa fa-chevron-right"></i> La evaluación consta de <strong><?php echo $ct_preguntasf; ?> preguntas</strong> (o menos) no calificables cuantitativamente y <strong>no hay límite de tiempo.</strong>
                                                        </p>-->
                                                        <p><i class="fa fa-chevron-right"></i> <strong>Cada pregunta tiene un solo intento,</strong> pero puedes pausar la evaluación y volver a ingresar para finalizarla.
                                                        </p>
                                                        
                                                    </div>
                                                        
                                                    <form name="formulario" id="formulario" method="post" action="eval_pres_sm1.php" enctype="multipart/form-data">
