                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="slider-content">';
                                if ($rowBanner['id'] == 15) {
                                    echo '<h2><span class="titulo2">'.$rowBanner['titulo'].'</span></h2> <h2><span class="titulo1">'.$rowBanner['subtitulo'].'</span></h2>
                                    <h3><span class="titulo3">'.$rowBanner['titulo2'].'</span><span> '.$rowBanner['subtitulo2'].'</span></h3>
                                    <p><span class="titulo3">'.$rowBanner['descripcion'].'</span></p>
                                    <div class="slider-btn">';
                                }
                                else {
                                    echo '<h2><span class="titulo">'.$rowBanner['titulo'].'</span></h2> <h2><span class="titulo1">'.$rowBanner['subtitulo'].'</span></h2>
...
<section id="blog-area" class="section-padding">
 ...
 <?php
$peticion580 = "SELECT IdBlog,TituloB,DATE_FORMAT(FechaPublicacionB, '%d de %M') AS fecha,ImagenB, DescripcionB 
    FROM blog WHERE estado_rev_texto != 0 AND estado_rev_mult != 0 ORDER BY IdBlog DESC LIMIT 3";
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="scholership-promo-text">
                    <h2>Cuadro de  <span>honor</span> a estudiantes de UNICAB en primer periodo</h2>
                    <p class="centrado">
                        <iframe width="800" height="450" src="https://www.youtube.com/embed/tMskBITQBnY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="scholership-promo-text">
                    ...
                    <p>Conoce nuestro calendario académico para el año 2021</p>
                    <a href="calendario/calendario-academico-2021.pdf" target="_blank" class="btn btn-brand">Ver más</a>
                </div>
            </div>
        </div>
    </div>
