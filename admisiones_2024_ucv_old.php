...
<head>
	...
	<script>
        ...
        $(function() {
			...
			//Se genera el intervalo de la fechaini
			let interval1 = setInterval(function() {
			    var fechaactual = new Date().getTime();
			    //var fechaactual = new Date("2022-06-30 18:30:00").getTime(); //Esto es para simular fechas --- se debe cambiar también en v1l3d1r_d31.php líneas 17 a 19
			    //console.log(fechaactual);
				
			    var fechaini = new Date(document.getElementById('fechaini1').value + " 23:59:59").getTime();
                //Se obtiene la diferencia entre las fechas
	            let diferencia = fechaini - fechaactual;
	            //console.log(diferencia);
	            
	            //Se hacen los cálculos
	            let dif_dias = (Math.floor(diferencia / (1000 * 60 * 60 * 24))) <= 0 ? 0 : Math.floor(diferencia / (1000 * 60 * 60 * 24));
	            let dif_horas = (Math.floor((diferencia % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60))) <= 0 ? 0 : Math.floor((diferencia % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
	            let dif_minutos = (Math.floor((diferencia % (1000 * 60 * 60)) / (1000 * 60))) <= 0 ? 0 : Math.floor((diferencia % (1000 * 60 * 60)) / (1000 * 60));
	            let dif_segundos = (Math.floor((diferencia % (1000 * 60)) / (1000))) <= 0 ? 0 : Math.floor((diferencia % (1000 * 60)) / (1000));
				console.log(dif_dias + " " + dif_horas + " " + dif_minutos + " " + dif_segundos);
	            
	            //Se muestran los valores
	            document.getElementById('pdias').innerHTML = dif_dias;
	            document.getElementById('phoras').innerHTML = dif_horas;
	            document.getElementById('pminutos').innerHTML = dif_minutos;
	            document.getElementById('psegundos').innerHTML = dif_segundos;
        ...
        function mostrar_submit() {
            ...
            var b = parseInt($("#ctr_register_nombrea").val());
            var c = parseInt($("#ctr_register_emaila").val());
            var d = parseInt($("#ctr_register_telefonoa").val());
            var e = parseInt($("#ctr_register_ciudada").val());
            //alert(h);
            
            control = parseInt($("#ctr_register_documentoe").val()) + parseInt($("#ctr_register_nombrea").val()) + parseInt($("#ctr_register_emaila").val()) + 
                parseInt($("#ctr_register_telefonoa").val()) + parseInt($("#ctr_register_ciudada").val());
            ...
            (b == 1) ? $("#register_nombrea").addClass("error") : $("#register_nombrea").removeClass("error");
            (c == 1) ? $("#register_emaila").addClass("error") : $("#register_emaila").removeClass("error");
            (d == 1) ? $("#register_telefonoa").addClass("error") : $("#register_telefonoa").removeClass("error");
            (e == 1) ? $("#register_ciudada").addClass("error") : $("#register_ciudada").removeClass("error");
        ...
        function val_documento() {
            ...
            $("#ctr_register_emaila").val(1);
            $("#ctr_register_telefonoa").val(1);
            $("#ctr_register_ciudada").val(1);
            
            //Se limpian lo cuadros de texto
            $("#register_nombrea").val("");
            $("#register_telefonoa").val("");
            $("#register_emaila").val("");
            $("#register_ciudada").val("");
			
			//Se desactivan los controles
			$("#register_nombrea").attr("disabled", "disabled");
            $("#register_telefonoa").attr("disabled", "disabled");
            $("#register_emaila").attr("disabled", "disabled");
            $("#register_ciudada").attr("disabled", "disabled");
			$("#btnEnviar").attr("disabled", "disabled");			
            		...
            		success:function(r) {
						...
						if(control_matricula == 0) {
							if(r_est == "activo") {
								...
								$("#register_telefonoa").val(res.telA);
								$("#register_emaila").val(res.emailA);
								$("#register_ciudada").val(res.ciudadA);
								
								$("#ctr_register_nombrea").val(0);
								$("#ctr_register_telefonoa").val(0);
								$("#ctr_register_emaila").val(0);
								$("#ctr_register_ciudada").val(0);
								
								$("#register_nombrea").removeAttr("disabled");
								$("#register_telefonoa").removeAttr("disabled");
								$("#register_emaila").removeAttr("disabled");
								$("#register_ciudada").removeAttr("disabled");
							}
								...
								(res.acudiente == "") ? $("#ctr_register_nombrea").val(1) : $("#ctr_register_nombrea").val(0);
								(res.telA == "") ? $("#ctr_register_telefonoa").val(1) : $("#ctr_register_telefonoa").val(0);
								(res.emailA == "") ? $("#ctr_register_emaila").val(1) : $("#ctr_register_emaila").val(0);
								(res.ciudadA == "") ? $("#ctr_register_ciudada").val(1) : $("#ctr_register_ciudada").val(0);
								
								$("#register_nombrea").removeAttr("disabled");
								$("#register_telefonoa").removeAttr("disabled");
								$("#register_emaila").removeAttr("disabled");
								$("#register_ciudada").removeAttr("disabled");
								//window.open("admisiones_nuevos.php"); //abrir ventana nueva
							}
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-11" id="cuentaRegresiva">
				<br>
				<div class="row">
					<div class='col-lg-5 col-md-5 col-sm-12'>
						<img src='assets/img/eventos/matriculas_2021_1.png' class='img-fluid' alt='Upcoming Event'>
						<p id="pCuentaRegresiva"><strong><?php echo "Cierre Matrículas Extraordinarias ".$diaCierre." de ".$nuevoMes." de ".$añoCierre; ?></strong></p>
					</div>
					...
					<div class='col-lg-7 col-md-7 col-sm-12'>
						...
						<!--<div class='row'>
							<div class="col-12">
								<h4 class="tituloTiempo"><b>Inicio Matrículas Extraordinarias <?php echo $descripcionE; ?></b></h4>
							</div>
						</div>-->
						
						<div class='row'>
							<div class="col-12">
								<h4 class="tituloTiempo"><b><?php echo $nombreE; ?></b></h4>
							</div>
						</div>
						
						<div class='row'>
							<div class="col-12">
								<p id="tituloEvento">Tiempo restante:</p>
							</div>
						</div>
						...
						<div class='row'>
							<div class='col-lg-3 col-md-3 col-sm-3'>
								<span>Días</span>
								<p id='pdias' class="tiempo">00</p>
							</div>
							<div class='col-lg-3 col-md-3 col-sm-3'>
								<span>Horas</span>
								<p id='phoras' class="tiempo">00</p>
							</div>
							<div class='col-lg-3 col-md-3 col-sm-3'>
								<span>Minutos</span>
								<p id='pminutos' class="tiempo">00</p>
							</div>
							<div class='col-lg-3 col-md-3 col-sm-3'>
								<span>Segundos</span>
								<p id='psegundos' class="tiempo">00</p>
							</div>
						</div>
						
					</div>
					<input type="hidden" id="fechaini1" value="<?php echo $fecha_ordinarias; ?>"/>
				</div>
			</div>
		</div>
	</div><br><br>	
			...
			<div class="col-lg-5 col-md-5 col-sm-12" id="divFormulario">
				<form name="formulario" id="formulario" method="post" action="registro_inicial_putdat.php" enctype="multipart/form-data">
					<div class="row" id="headerFormulario">
						<div class="col-12">
							<center>
								...
								<h6 id="textoMatriculas">Ingresa los siguientes datos para iniciar el proceso de matrícula en nuestro colegio UNICAB virtual</h6>
							</center>
						</div>
					</div><br>
					...
					<div class="row">
						<div class="col-12">
							<div class="form-group">
								<label for="register_apellidos"><label class="obligatorio">*</label> Nombre acudiente</label>
								<input type="text" class="form-control" id="register_nombrea" name="register_nombrea" placeholder="Escribe el nombre del acudiente" required onkeyup="mayus(this, 'register_nombrea', 'Nombre acudiente');" disabled>
					...
					<div class="row">
						<div class="col-12">
							<div class="form-group">
								<label for="register_nombres"><label class="obligatorio">*</label> Email acudiente</label>
								<input type="text" class="form-control" id="register_emaila" name="register_emaila" required placeholder="Escribe el email del acudiente" onkeyup="validar_email('register_emaila', 'Email acudiente');" disabled>
								<input type="hidden" style="width: 20px" id="ctr_register_emaila" value="1"/>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
							<div class="form-group">
								<label for="register_nombres"><label class="obligatorio">*</label> Teléfono acudiente</label>
								<input type="text" class="form-control" id="register_telefonoa" name="register_telefonoa" required placeholder="Escribe el teléfono del acudiente" onkeyup="validar_numero('register_telefonoa', 'Teléfono acudiente');" disabled>
								<input type="hidden" style="width: 20px" id="ctr_register_telefonoa" value="1"/>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
							<div class="form-group">
								<label for="register_nombres"><label class="obligatorio">*</label> Ciudad acudiente</label>
								<input type="text" class="form-control" id="register_ciudada" name="register_ciudada" required placeholder="Escribe la ciudad del acudiente" onkeyup="mayus(this, 'register_ciudada', 'Ciudad acudiente');" disabled>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 pl-5">
				<div class="row">
					<div class="col-12">
						...
						<!--<h5 class="mark">No dejes que las barreras geográficas te impidan recibir una educación de calidad.</h5>-->
						<img src="assets/img/admisiones/AVISO_1.png" id="imgAviso" class="img-fluid"/>
					</div>
				</div><br>
				<div class="row">
					<center class="centrado">
						<p><iframe width="560" height="315" src="https://www.youtube.com/embed/fFc0EsKN2jw?si=NUiCK16PaEwDaIvy" class="responsive-iframe" 
	...
	<div class="container" id="divDos">
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-12">
				<div class="row">
					<div class="col-12">
						<h5 id="tituloDos"><strong>Descubre Nuestro Innovador Modelo Educativo:</strong> El ECOSISTEMA de Colegio UNICAB Virtual.</h5>
					</div>
				</div><br>
				<div class="row">
					<div class="col-12">						
						<p id="pDos">Un <strong>ECOSISTEMA</strong> define el modelo pedagógico del <strong>Colegio UNICAB Virtual</strong> donde el estudiante 
						es el eje y centro de todo el quehacer pedagógico, modelo pensado, estudiado, investigado y puesto en marcha utilizando las TIC para 
						atender a personas con necesidades socioeconómicas especiales, orientado por maestros mediadores con mentalidad abierta que se han 
						preparado, se retan y sienten el placer y el honor de acompañar estudiantes activos y propositivos que se preparan en la era del 
						conocimiento.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 pl-5">
				<div class="row">
					<div class="col-12">
						<h4 id="tituloDosB"><strong>Trabajamos y fortalecemos pensamientos</strong></h4>
					</div>
				</div><br>
				<div class="row">
					<!--<div class="col-12">
						<img src="assets/img/admisiones/pensamientos_1.png" alt="" class="img-fluid imgDos animacionmenu"/>						
					</div>-->
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img src="assets/img/admisiones/matematico_2.png" alt="" class="img-fluid imgDos animacionmenu"/>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img src="assets/img/admisiones/social_2.png" alt="" class="img-fluid imgDos animacionmenu"/>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img src="assets/img/admisiones/español_2.png" alt="" class="img-fluid imgDos animacionmenu"/>
					</div>
				</div><br>
				<div class="row">
					<!--<div class="col-12">
						<img src="assets/img/admisiones/pensamientos_2.png" alt="" class="img-fluid imgDos animacionmenu"/>
					</div>-->
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img src="assets/img/admisiones/ingles_2.png" alt="" class="img-fluid imgDos animacionmenu"/>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img src="assets/img/admisiones/tecnologico_2.png" alt="" class="img-fluid imgDos animacionmenu"/>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<img src="assets/img/admisiones/bioetico_2.png" alt="" class="img-fluid imgDos animacionmenu"/>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container" id="divTres">
		<div class="row">
			<div class="col-12">
				<center><h3 id="tituloTres"><strong>Te ofrecemos:</strong></h3></center>
			</div>
		</div><br>
		...
		<div class="row">
			...
			<div class="col-10">
				<!--<img src="assets/img/admisiones/te_ofrecemos.png" alt="" class="img-fluid ml-5 pl-5 animacionmenu" id="imgTres"/>-->
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-12">
						<img src="assets/img/admisiones/Primaria_1.png" alt="" class="img-fluid imgTres animacionmenu"/>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
						<img src="assets/img/admisiones/Bachillerato_1.png" alt="" class="img-fluid imgTres animacionmenu"/>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
						<img src="assets/img/admisiones/ciclos_1.png" alt="" class="img-fluid imgTres animacionmenu"/>
					</div>
				</div>
			</div>
			<div class="col-1">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-11 col-md-11 col-sm-12" id="divCuatro">
				<div class="row">
					<div class="col-12">
						<center><h3 id="tituloCuatro"><strong>¿Por qué elegirnos?</strong></h3></center>
					</div>
				</div><br><br>
						...
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-12">
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-sm-12 blanco animacionmenu">
										<p class="pCuatroTransp">...</p>
										<img src="assets/img/admisiones/1c.png" alt="" class="img-fluid imgCuatro"/>
										<p class="pCuatro"><strong>Flexibilidad total:</strong></p>
										<p class="pCuatroB">Olvídate de las limitaciones de horario y ubicación. Con UNICAB VIRTUAL, puedes estudiar desde cualquier lugar y 
										en cualquier momento. Ajusta tus clases a tu propio ritmo y conveniencia.</p>
									</div>
									<div class="col-lg-1 col-md-1 col-sm-12">				
									</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12">
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-sm-12 blanco animacionmenu">
										<p class="pCuatroTransp">...</p>
										<img src="assets/img/admisiones/2c.png" alt="" class="img-fluid imgCuatro"/>
										<p class="pCuatro"><strong>Maestros mediadores altamente capacitados:</strong></p>
										<p class="pCuatroB">Contamos con un equipo de profesionales apasionados y expertos en su campo. Nuestros maestros mediadores están 
										comprometidos en brindarte una educación de calidad, fomentando tu crecimiento académico y personal.</p>
									</div>
									<div class="col-lg-1 col-md-1 col-sm-12">				
									</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12">
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-sm-12 blanco animacionmenu">
										<p class="pCuatroTransp">...</p>
										<img src="assets/img/admisiones/3c.png" alt="" class="img-fluid imgCuatro"/>
										<p class="pCuatro"><strong>Tecnología de vanguardia:</strong></p>
										<p class="pCuatroB">En UNICAB VIRTUAL, nos enorgullece utilizar la última tecnología educativa. Con herramientas interactivas, 
										recursos multimedia y plataforma digital innovadora, te sumergirás en un entorno de aprendizaje dinámico y enriquecedor.</p>
									</div>
									<div class="col-lg-1 col-md-1 col-sm-12">				
									</div>
								</div>
						...
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-12">
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-sm-12 blanco animacionmenu">
										<p class="pCuatroTransp">...</p>
										<img src="assets/img/admisiones/4c.png" alt="" class="img-fluid imgCuatro"/>
										<p class="pCuatro"><strong>Programa académico completo:</strong></p>
										<p class="pCuatroB">Nuestro currículo está diseñado para brindarte una educación integral. Desde la educación primaria hasta la 
										educación media, ofrecemos un modelo pedagógico denominado ecosistema UNICAB para nutrir tus habilidades en todas las áreas.</p>
									</div>
									<div class="col-lg-1 col-md-1 col-sm-12">
									</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12">
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-sm-12 blanco animacionmenu">
										<p class="pCuatroTransp">...</p>
										<img src="assets/img/admisiones/5c.png" alt="" class="img-fluid imgCuatro"/>
										<p class="pCuatro"><strong>Tiempo para compartir con tu familia y proyecto de vida:</strong></p>
										<p class="pCuatroB">Se traduce en un valioso equilibrio entre tus responsabilidades académicas y la vida personal. Al elegir UNICAB, 
										no solo disfrutarás de más tiempo para fortalecer lazos familiares, sino que también encontrarás el espacio para nutrir tus aspiraciones 
										personales y proyectos de vida.</p>
									</div>
									<div class="col-lg-1 col-md-1 col-sm-12">	
									</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12">
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-sm-12 blanco animacionmenu">
										<p class="pCuatroTransp">...</p>
										<img src="assets/img/admisiones/6c.png" alt="" class="img-fluid imgCuatro"/>
										<p class="pCuatro"><strong>Disminución de costos:</strong></p>
										<p class="pCuatroB">Estudiar en UNICAB no solo te permitirá ahorrar en gastos relacionados con transporte, materiales impresos y útiles 
										escolares, sino que también te preparará mejor para afrontar los desafíos del futuro con un enfoque en la eficiencia y la sostenibilidad.</p>
									</div>
									<div class="col-lg-1 col-md-1 col-sm-12">			
									</div>
								</div>
	...
	<div class="container" id="divCinco">
		...
		<div class="row">
			<div class="col-12">
				<center><h3 id="tituloCinco"><strong>Documentos legales:</strong></h3></center>
			</div>
		</div><br>
