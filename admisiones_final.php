                                                ...
                                                <div class="register-form" id="divform">
                                                    ...
                                                    <form name="formulario" id="formulario" method="post" action="https://unicab.solutions/send_f.php" enctype="multipart/form-data"> 
                                                        ...
                                                        <div class="form-group file-input">   
                                                            ...
                                                            <input type="file" id="adjunto" name="adjunto" required accept=".pdf" class="ArchivosAdjuntos">
                                                        ...
                                                        <div class="form-group file-input">   
                                                            ...
                                                            <input type="file" id="adjunto2" name="adjunto2" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
														<!--CARGA DE ARCHIVO-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto16"><i class="fa fa-asterisk" aria-hidden="true"></i><span style="color: transparent;">_</span>
															<i class="fa fa-upload"></i> Adjunta el registro civil de nacimiento del estudiante 
                                                            <a data-toggle="collapse" href="#collapseExample4_a" role="button" aria-expanded="false" aria-controls="collapseExample4_a"> (Ayuda)</a></label><br>
                                                            <div class="collapse" id="collapseExample4_a">
                                                                <div class="card card-body">
                                                                    <p>Escanea y sube el registro civil de nacimiento del estudiante. <span class="badge badge-secondary">Formato PDF</span></p>
                                                                </div>
                                                            </div>
                                                            <input type="file" id="adjunto16" name="adjunto16" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        <!--CARGA DE ARCHIVO-->
                                                        <div class="form-group file-input">   
                                                            ...
                                                            <input type="file" id="adjunto3" name="adjunto3" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        <!--CARGA DE ARCHIVO-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto4"><i class="fa fa-asterisk" aria-hidden="true"></i><span style="color: transparent;">_</span>
                                                            ...
                                                            <input type="file" id="adjunto4" name="adjunto4" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        ...
                                                        <div class="form-group file-input">   
                                                            ...
                                                            <input type="file" id="adjunto5" name="adjunto5" accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        <!--CARGA DE ARCHIVO-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto6"><i class="fa fa-upload"></i> Adjunta el certificado de Retiro del SIMAT <mark>(Estudiantes nuevos sólamente)</mark>
                                                            ...
                                                            <input type="file" id="adjunto6" name="adjunto6" accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        <!--CARGA DE ARCHIVO-->
                                                        <div class="form-group file-input">   
                                                            ...
                                                            <input type="file" id="adjunto7" name="adjunto7" required accept=".jpg,.png,.jpeg" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        ...
                                                        <div class="form-group file-input">   
                                                            ...
                                                            <input type="file" id="adjunto8" name="adjunto8" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        <!--CARGA DE ARCHIVO-->
                                                        <div class="form-group file-input">   
                                                            ...
                                                            <input type="file" id="adjunto9" name="adjunto9" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        <!--CARGA DE ARCHIVO-->
                                                        <div class="form-group file-input">   
                                                           ...
                                                           <input type="file" id="adjunto10" name="adjunto10" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE ARCHIVO-->
                                                        <!--CARGA DE RUT-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto11"><i class="fa fa-asterisk" aria-hidden="true"></i><span style="color: transparent;">_</span>
															<i class="fa fa-upload"></i> Adjunta el RUT (Registro Unico Tributario) del acudiente responsable, necesario para la facturación electrónica.
                                                            ...
                                                            <input type="file" id="adjunto11" name="adjunto11" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DE RUT-->
                                                        <!--CARGA VACUNACION-->
                                                        <div class="form-group file-input">   
                                                            ...
                                                            <input type="file" id="adjunto12" name="adjunto12" accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA VACUNACION-->
                                                        <!--CARGA CONSENTIMIENTO INFORMADO-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto13"><i class="fa fa-asterisk" aria-hidden="true"></i><span style="color: transparent;">_</span>
															<i class="fa fa-upload"></i> Adjunta el Consentimiento Informado enviado al correo del acudiente.
                                                            ...
                                                            <input type="file" id="adjunto13" name="adjunto13" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA CONSENTIMIENTO INFORMADO-->
														<!--CARGA CARTA SOLICITANDO MATRICULA VIRTUAL-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto14"><i class="fa fa-asterisk" aria-hidden="true"></i><span style="color: transparent;">_</span>
															<i class="fa fa-upload"></i> Adjunta una carta solicitando que el estudiante sea matriculado en modalidad virtual.
                                                            <a data-toggle="collapse" href="#collapseExample16" role="button" aria-expanded="false" aria-controls="collapseExample16"> (Ayuda)</a></label><br>
                                                            <div class="collapse" id="collapseExample16">
                                                                <div class="card card-body">
                                                                    <p>Escanea y sube la carta solicitando que el estudiante sea matriculado en modalidad virtual. <span class="badge badge-secondary">Formato PDF</span></p>
                                                                </div>
                                                            </div>
                                                            <input type="file" id="adjunto14" name="adjunto14" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA CARTA SOLICITANDO MATRICULA VIRTUAL-->
														<!--CARGA DOCUMENTO QUE ACREDITA LA CONDICION SOCIO-ECONOMICA-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto15"><i class="fa fa-asterisk" aria-hidden="true"></i><span style="color: transparent;">_</span>
															<i class="fa fa-upload"></i> Certificación laboral del acudiente.
                                                            <a data-toggle="collapse" href="#collapseExample17" role="button" aria-expanded="false" aria-controls="collapseExample17"> (Ayuda)</a></label><br>
                                                            <div class="collapse" id="collapseExample17">
                                                                <div class="card card-body">
                                                                    <p>Escanea y sube la certificación laboral del acudiente. <span class="badge badge-secondary">Formato PDF</span></p>
                                                                </div>
                                                            </div>
                                                            <input type="file" id="adjunto15" name="adjunto15" required accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DOCUMENTO QUE ACREDITA LA CONDICION SOCIO-ECONOMICA-->
														<!--CARGA DOCUMENTO OBSERVADOR-->
                                                        <div class="form-group file-input">   
                                                            <label for="adjunto17"><i class="fa fa-upload"></i> Hoja de vida, observador o reporte comportamental y académico año anterior <mark>(Estudiantes nuevos sólamente)</mark>.
                                                            <a data-toggle="collapse" href="#collapseExample18" role="button" aria-expanded="false" aria-controls="collapseExample18"> (Ayuda)</a></label><br>
                                                            <div class="collapse" id="collapseExample18">
                                                                <div class="card card-body">
                                                                    <p>Escanea y sube la hoja de vida, observador o reporte comportamental y académico año anterior. <span class="badge badge-secondary">Formato PDF</span></p>
                                                                </div>
                                                            </div>
                                                            <input type="file" id="adjunto17" name="adjunto17" accept=".pdf" class="ArchivosAdjuntos">
                                                        </div>
                                                        <!--FIN CARGA DOCUMENTO OBSERVADOR-->
