<?php
	...
	//redireccionamos a unicab.solutions para el envío del correo al acudiente con el contrato y el link para subir documentos
	//header('Location: resultado_pre_admisiones_f.php?s='.$resultado);
	//echo "<br/>página: ".'https://unicab.solutions/pre_admisiones1_us_antiguos.php?documento='.$documento.'&c='.$codigo.'&msgest='.$msg_estudiante.'&sqlinsert='.$sql_insert2.'&emailA='.$emailA;
	
	//echo "<script>location.href='https://unicab.solutions/pre_admisiones1_us_antiguos.php?documento=".$documento."&c=".$codigo."&msgest=".$msg_estudiante."&emailA=".$emailA."&sqlinsert=".$sql_insert2."';</script>";
    
	header('Location: https://unicab.solutions/pre_admisiones1_us_antiguos.php?documento='.$documento.'&c='.$codigo.'&msgest='.$msg_estudiante.'&emailA='.$emailA);
