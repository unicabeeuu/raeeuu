<?php
    ...
    $content .= '<script src="assets/vendor/modernizr/modernizr-custom.js"></script>
    ...
    $content .= '#divimagen, #divtextopregunta {height: 350px;}';
    ...
    $content .= '.imgpreg {margin-top: 10px;}
                 .p2 {display: none;}
                 .oculto {display: none;}
                 .nooculto {display: inline;}
                 #tblres {table-layout: fixed;}
    ...
    $content .= '.GridviewScrollItemHover TD {background-color: #CCCCCC; color: blue;}';
    
    $content .= '</style>';
    $content .= '</head><body>';
    
    $content1 = '';
    $content1 .= '<div class="col-lg-12 col-md-12 ml-auto">';
        $content1 .= '<div class="register-form-wrap">';
            $content1 .= '<h3><span class="badge badge-success">Hola </span> '.$nombre_completo.'</h3>';
            $content1 .= '<div class="register-form" id="divform">';
