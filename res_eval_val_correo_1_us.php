<?php
    ...
    //https://unicab.org/res_eval_val_correo_1_us.php?n_documento=1013269543&idgra=6
    ...
    //echo $msg_correo;
    header('location: https://unicab.solutions/res_eval_val_correo_1_us.php?n_documento='.$documento.'&idgra='.$idgra.'&msg='.$msg_correo.'&pdf='.$ruta);
    echo "<script>location.href='https://unicab.solutions/res_eval_val_correo_1_us.php?n_documento=".$documento."&idgra=".$idgra."&msg=".$msg_correo."&pdf=".$ruta."';</script>";
    // ###################### FIN ENVIO DE CORREO ###################
