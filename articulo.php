                        ...
                        <header class="article-head">
                            ...
                            <div class="single-blog-meta">
                                ...
                                <div class="posting-info">
                                    <?php echo $fecha; ?>
                                    <div style="font-size: 12px; text-align: right;"><?php echo $autor; ?></div> 
                                </div>
                            </div>
							...
							?>
								<div class="mt-5 text-center">
									<a href="assets/pdfs/Fundamento_Teorico_para_Ecosistema_de_educacion virtual_Colegio_Unicab_Virtual_Colombia.pdf" target="_blank" class="btn  btn-warning" id="btn_warning">Descargar</a>
								</div><br>
							<?php
								}
								else if($_GET['id'] == 82) {
							...
							?>
								<div class="mt-5 text-center">
									<a href="assets/pdfs/La_Fuerza_del_Relato_de_las_Familias_para_la_Produccion_de_Conocimiento_en_Colegio_Virtual_Unicab_Sogamoso.pdf" target="_blank" class="btn  btn-warning" id="btn_warning">Descargar</a>
								</div><br>
							<?php
								}
								else if($_GET['id'] == 83) {
							...
							?>
								<div class="mt-5 text-center">
									<a href="assets/pdfs/Libro_Fundamento_Teorico_Ecosistema_Unicab.pdf" target="_blank" class="btn  btn-warning" id="btn_warning">Descargar</a>
								</div><br>
							<?php
								}
								else if($_GET['id'] == 84) {
							...
							?>
								<div class="mt-5 text-center">
									<a href="assets/pdfs/Metodologia_Ecosistema_Unicab.pdf" target="_blank" class="btn  btn-warning" id="btn_warning">Descargar</a>
								</div><br>
							<?php
								}
							?>
       ...
       <h4 class="sidebar-title">Últimos Artículos</h4>
		...
		$resultado = mysqli_query($conexion, $peticion);
			while ($fila = mysqli_fetch_array($resultado)){ 
				...
				echo" <li><a href='articulo.php?id=".$id2."#page-content-wrap'><span class='badge badge-primary'>".$fecha2."</span><img src='".substr($fila['ImagenB'], 9)."' class='img-fluid' alt='Articulo'>".$titulo2."</a></li>";
			};
?>
