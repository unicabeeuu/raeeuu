                    ...
                    <div class="page-title-content">
                        <?php
                            if($resultados[0] == "CorreoOK" && $resultados[1] == "EstudianteOK") {
                                echo "<h4>¡EL CORREO DE VERIFICACION SE ENVIÓ CON ÉXITO a ".$resultados[2]."!</h4>";
                                echo "<h5>¡Puede tardar entre 5 a 10 minutos en llegar... Por favor revisar el spam o correos no deseados!</h5><hr>";
                                echo "<h4>Resumen:</h4><h5>Descargue el Contrato de Matrícula, diligéncielo y lo anexa cuando termine el proceso de matrícula.</h5>";
                                /*echo "<h5>Orden de pago del primer pago enviada con éxito. Cancele y escanee el recibo de pago.</h5><hr>";*/
								echo "<h5>Encontrará un link para continuar con el proceso de matrícula. </h5><hr>";
								echo "<h5>Al abrir el coreo es probable que le aparezca una imagen como la siguiente:</h5>";
