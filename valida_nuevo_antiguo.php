<?php
    ...
    $documentoe = $_REQUEST['register_documentoe'];
	...
	if ($estado == "nuevo") {
		...
		header('Location: admisiones_nuevos_2025.php?documento='.$documentoe.'&idgra='.$idgra.'&amatricula='.$año_matricula);
	}
	else {
		...
		header('Location: admisiones_antiguos_2025.php?documento='.$documentoe.'&idgra='.$idgra.'&amatricula='.$año_matricula);
	}
