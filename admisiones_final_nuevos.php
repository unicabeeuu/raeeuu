	...
	<div class="container" id="divOcho">
		...
		<form name="formulario" id="formulario" method="post" action="https://unicab.solutions/send_f.php" enctype="multipart/form-data">
			...
			<div class="container datosEstudiante">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-10 col-10 azuloscuro">
							<h6>Paso 4</h6>
							<h6>SUBE EL CONTRATO DE MATRÍCULA Y EL PAGARÉ</h6>
						</div>
					</div>
					<br>
				</div>		
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						...
						<input type="file" id="adjunto2" name="adjunto2" required accept=".pdf" class="ArchivosAdjuntos" disabled>
					</div>
				</div>
			</div>
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						...
						<input type="file" id="adjunto16" name="adjunto16" required accept=".pdf" class="ArchivosAdjuntos" disabled>
					</div>
				</div>
			</div>
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						...
						<input type="file" id="adjunto12" name="adjunto12" accept=".pdf" class="ArchivosAdjuntos" disabled>
					</div>
				</div>
			</div>
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						...
						<input type="file" id="adjunto4" name="adjunto4" required accept=".pdf" class="ArchivosAdjuntos" disabled>
					</div>
				</div>
			</div>
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						<label for="adjunto6"><i class="fa fa-asterisk" aria-hidden="true"></i><span style="color: transparent;">_</span>
						<i class="fa fa-upload"></i> Adjunta el certificado de Retiro del SIMAT <!--<mark>(Estudiantes nuevos sólamente)</mark>-->
						...
						<input type="file" id="adjunto6" name="adjunto6" required accept=".pdf" class="ArchivosAdjuntos" disabled>
					</div>
				</div>
			</div>
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						...
						<i class="fa fa-upload"></i> Adjunta el comprobante del primer pago por concepto de <mark><u>matrícula 2024</u></mark> únicamente
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						...
						<input type="file" id="adjunto14" name="adjunto14" required accept=".pdf" class="ArchivosAdjuntos" disabled>
					</div>
				</div>
			</div>
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						<label for="adjunto17"><i class="fa fa-asterisk" aria-hidden="true"></i><span style="color: transparent;">_</span>
						<i class="fa fa-upload"></i> Hoja de vida, observador o reporte comportamental y académico año anterior <!--<mark>(Estudiantes nuevos sólamente)</mark>-->.
						...
						<input type="file" id="adjunto17" name="adjunto17" required accept=".pdf" class="ArchivosAdjuntos" disabled>
					</div>
				</div>
			</div>
			...
			<div class="row ml-5">
				<div class="col-12">
					<div class="form-group file-input">   
						...
						<input type="file" id="adjunto3" name="adjunto3" required accept=".pdf" class="ArchivosAdjuntos" disabled>
					</div>
				</div>
			</div>
