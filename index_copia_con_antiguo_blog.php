...
<?php    
    ...
    while ($rowImagen = mysqli_fetch_array($exe_banner)) {
        if($rowImagen['id'] == 29 || $rowImagen['id'] == 27) {
    ...
    <div class="slider-active-wrap owl-carousel text-center text-md-left">
        ...
        <?php 
            ...
            while ($rowBanner = mysqli_fetch_array($exe_banner1)) {
                if($rowBanner['id'] == 26 || $rowBanner['id'] == 27 || $rowBanner['id'] == 28 || $rowBanner['id'] == 29) {
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="slider-content">
                                    ...
                                    <h2><span class="titulo1" style="color: transparent !Important;">'.$rowBanner['subtitulo'].'</span></h2>
                                    <h3 style="color: transparent !Important;">'.$rowBanner['titulo2'].'<span> '.$rowBanner['subtitulo2'].'</span></h3>
                                    <p style="padding-top: 600px;">'.$rowBanner['descripcion'].'</p>
                                    <div class="slider-btn">';
                }
                else {
                    echo ' <div class="single-slide-wrap slide-bg-'.$cont1.'">
...
<div class="contenedor-video">
    <!-- class="contenedor-video" -->

<!--
<h2>CUADRO DE HONOR SEGUNDO PERIODO</H2>
<br></br>

<iframe width="800" height="400" src="https://www.youtube.com/embed/j5C_UkmsylU?autoplay=1&muted=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
-->

<!-- <H2>II CONGRESO INTERNACIONAL - PONENTES</H2> -->
<!-- <img src="assets/img/fotos-historia/historia-2001.jpg" alt="About" class="img-fluid img-left"> -->
<!-- <img src="assets/img/segundocongreso/II congreso 1.jpg" alt="About" class="img-fluid img-left -->
<!-- <img src="assets/img/segundocongreso/II congreso 2.jpg" alt="About" class="img-fluid img-left"> -->
<!-- <img src="assets/img/segundocongreso/II congreso 3.jpg" alt="About" class="img-fluid img-left"> -->

<h2>DANZA, SALUD Y FUERZA</H2>
<br></br>

<iframe width="800" height="400" src="https://www.youtube.com/embed/BvrvAc3SiO8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="scholership-promo-text">
                    ...
                    <p>Conoce nuestro calendario académico para el año 2022</p>
                    <a href="calendario/Calendario_2022_Unicab.pdf" target="_blank" class="btn btn-brand">Ver más</a>
                </div>
            </div>
        </div>
    </div>
...
<section id="blog-area" class="section-padding">
 ...
 <?php
$peticion580 = "SELECT IdBlog,TituloB,DATE_FORMAT(FechaPublicacionB, '%d de %M') AS fecha,ImagenB, DescripcionB FROM blog 
