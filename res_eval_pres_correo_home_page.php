<?php
    ...
    //https://unicab.org/res_eval_pres_correo_home_page.php?n_documento=999999&idgra=10
	...
	//local
    //header('location: http://localhost:90/cartiexplora/business/org/pages/resultado_eval_pres.php?n_documento='.$documento.'&idgra='.$idgra.'&msg='.$msg_correo);
    //echo "<script>location.href='http://localhost:90/cartiexplora/business/org/pages/resultado_eval_pres.php?n_documento=".$documento."&idgra=".$idgra."&msg=".$msg_correo."';</script>";
	
	//servidor
	header('location: https://unicab.org/resultado_eval_pres.php?n_documento='.$documento.'&idgra='.$idgra.'&msg='.$msg_correo);
    echo "<script>location.href='https://unicab.org/resultado_eval_pres.php?n_documento=".$documento."&idgra=".$idgra."&msg=".$msg_correo."';</script>";
